<div class="max-w-7xl mx-auto pb-12">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-slate-400 text-sm mt-1">Pantau seluruh rekam jejak perubahan Master Data (Produk, Supplier, Pelanggan).</p>
        </div>
        
        <div class="flex items-center gap-3 w-full md:w-auto">
            <div class="relative flex-1 md:w-64">
                <i data-lucide="search" class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-slate-500"></i>
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari Log..." class="w-full pl-9 pr-4 py-2 bg-[#0D1117] border border-[#30363D] rounded-xl text-sm text-slate-200 placeholder-slate-500 focus:border-[#58A6FF] outline-none transition-colors">
            </div>
        </div>
    </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="border-b border-[#30363D]">
                        <th class="py-3 px-4 text-xs font-bold text-slate-400 uppercase tracking-wider">Waktu & User</th>
                        <th class="py-3 px-4 text-xs font-bold text-slate-400 uppercase tracking-wider">Aksi & Modul</th>
                        <th class="py-3 px-4 text-xs font-bold text-slate-400 uppercase tracking-wider">Ringkasan Perubahan Detail</th>
                    </tr>
                </thead>
                    ...
                    @forelse($logs as $log)
                        <tr class="hover:bg-[#0D1117] transition-colors group">
                            <td class="py-4 px-4 align-top w-56">
                                <p class="font-bold text-slate-200 group-hover:text-white transition-colors mb-0.5">
