...
<div class="w-full">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-slate-900 card-shadow border border-[#D1D5DB] dark:border-slate-800 rounded-2xl p-5 lg:p-6 shadow-xl transition-colors duration-300 ease-in-out flex flex-col">
                    ...
                    @forelse($transaksi as $t)
                        <tr class="hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-center transition-colors duration-300 ease-in-out">
                                <span class="inline-block px-1.5 py-0.5 text-[10px] font-bold rounded {{ $t->type == 'IN' ? 'bg-[#10B981] dark:bg-emerald-500/20 text-[#3FB950] border border-[#238636]/30' : ($t->type == 'OUT' ? 'bg-rose-500/20 text-rose-600 dark:text-rose-400 border border-rose-500/30' : 'bg-blue-500/20 text-[#10B981] dark:text-blue-400 border border-blue-500/30') }} transition-colors duration-300 ease-in-out">
                                    {{ $t->type }}
                                </span>
                            </td>
