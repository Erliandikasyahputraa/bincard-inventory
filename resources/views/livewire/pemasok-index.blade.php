...
<div class="w-full">
    <div class="flex flex-col sm:flex-row justify-end items-center gap-4 mb-4 lg:mb-6">
        <div class="flex flex-col sm:flex-row w-full sm:w-auto gap-3">
            ...
            <a href="{{ route('pemasok.tambah') }}" class="inline-flex justify-center items-center px-4 py-2.5 bg-[#10B981] dark:bg-blue-500 hover:bg-[#388BFD] text-white font-bold rounded-xl transition-colors shadow-lg shadow-[#1F6FEB]/20 text-sm whitespace-nowrap">
