<div class="w-full">
    <div class="mb-6">
        ...
        <p class="text-[#4A7FA7]/70 dark:text-slate-400 text-sm mt-1 transition-colors duration-300 ease-in-out">Catat stok masuk. Setiap transaksi tercatat di ledger.</p>
    </div>
    ...
    <div class="bg-white dark:bg-[#161B22] border border-[#B3CFE5]/30 dark:border-[#30363D] rounded-2xl shadow-xl overflow-hidden max-w-4xl transition-colors duration-300 ease-in-out">
        <form wire:submit="simpan" class="p-6 md:p-8 space-y-6">
            ...
            <div class="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 mb-2 transition-colors duration-300 ease-in-out">
                <label class="block text-[11px] font-bold text-blue-400 uppercase tracking-wider mb-2 transition-colors duration-300 ease-in-out">Pencarian Cepat (Barcode)</label>
                <div class="flex gap-2">
                    ...
                    <button type="button" wire:click="pilihProdukDariBarcode" 
                        class="px-4 py-2.5 bg-[#F6FAFD] dark:bg-[#21262D] border border-[#B3CFE5]/30 dark:border-[#30363D] hover:bg-[#30363D] text-[#4A7FA7] dark:text-slate-300 font-bold rounded-xl transition-colors text-sm whitespace-nowrap">
                        Cari
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-[11px] font-bold text-[#4A7FA7]/70 dark:text-slate-400 uppercase tracking-wider mb-2 transition-colors duration-300 ease-in-out">Jumlah Barang <span class="text-rose-500 transition-colors duration-300 ease-in-out">*</span></label>
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-[11px] font-bold text-[#4A7FA7]/70 dark:text-slate-400 uppercase tracking-wider mb-2 transition-colors duration-300 ease-in-out">No. Referensi / PO</label>
                        <input type="text" wire:model="referensi" 
                            class="w-full bg-[#F6FAFD] dark:bg-[#0D1117] border border-[#B3CFE5]/30 dark:border-[#30363D] hover:border-[#8B949E] rounded-xl text-[#1A3D63] dark:text-slate-200 placeholder-slate-600 focus:bg-white dark:bg-[#161B22] focus:border-[#58A6FF] focus:ring-1 focus:ring-[#58A6FF] outline-none transition-all px-4 py-2.5 text-sm" 
                            placeholder="Contoh: PO-2024-001 (Opsional)">
                    </div>

                    <div>
                        <label class="block text-[11px] font-bold text-[#4A7FA7]/70 dark:text-slate-400 uppercase tracking-wider mb-2 transition-colors duration-300 ease-in-out">Catatan Tambahan</label>
            ...
            <div class="pt-6 border-t border-[#B3CFE5]/30 dark:border-[#30363D] flex justify-end transition-colors duration-300 ease-in-out">
                <button type="submit" wire:loading.attr="disabled" wire:target="simpan" class="w-full sm:w-auto px-6 py-3 bg-[#238636] hover:bg-[#2EA043] text-white disabled:opacity-50 font-bold rounded-xl transition-colors shadow-lg shadow-[#1A3D63]/20 dark:shadow-[#3FB950]/20 flex justify-center items-center text-sm">
