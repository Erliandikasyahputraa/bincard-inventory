<div class="w-full">
    <div class="mb-6">
        ...
        <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Catat stok masuk. Setiap transaksi tercatat di ledger.</p>
    </div>
        ...
        <form wire:submit="simpan" class="p-6 md:p-8 space-y-6">
            ...
            <div class="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 mb-2">
                ...
                <div class="flex gap-2">
                    ...
                    <button type="button" wire:click="pilihProdukDariBarcode" 
                        class="px-4 py-2.5 bg-[#21262D] border border-[#30363D] hover:bg-[#30363D] text-slate-700 dark:text-slate-300 font-bold rounded-xl transition-colors text-sm whitespace-nowrap">
                        Cari
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Jumlah Barang <span class="text-rose-500">*</span></label>
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">No. Referensi / PO</label>
                        <input type="text" wire:model="referensi" 
                            class="w-full bg-[#0D1117] border border-[#30363D] hover:border-[#8B949E] rounded-xl text-slate-800 dark:text-slate-200 placeholder-slate-600 focus:bg-[#161B22] focus:border-[#58A6FF] focus:ring-1 focus:ring-[#58A6FF] outline-none transition-all px-4 py-2.5 text-sm" 
                            placeholder="Contoh: PO-2024-001 (Opsional)">
                    </div>

                    <div>
                        <label class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Catatan Tambahan</label>
