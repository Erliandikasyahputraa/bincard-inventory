    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden transition-colors duration-300 ease-in-out">
            ...
            <form wire:submit="updateProfile" class="space-y-5 relative z-10">
                ...
                <div class="pt-4 border-t border-slate-200 dark:border-slate-800/50 transition-colors duration-300 ease-in-out">
                    <button type="submit" class="w-full sm:w-auto px-6 py-3 bg-blue-600 dark:bg-blue-500 hover:bg-[#388BFD] text-white font-bold rounded-xl transition-all shadow-lg shadow-[#1F6FEB]/20 flex items-center justify-center gap-2" wire:loading.attr="disabled">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden transition-colors duration-300 ease-in-out">
            ...
            <form wire:submit="updatePassword" class="space-y-5 relative z-10">
                ...
                <div class="pt-4 border-t border-slate-200 dark:border-slate-800/50 transition-colors duration-300 ease-in-out">
                    <button type="submit" class="w-full sm:w-auto px-6 py-3 bg-emerald-600 dark:bg-emerald-500 hover:bg-emerald-700 dark:hover:bg-emerald-600 text-white font-bold rounded-xl transition-all shadow-lg flex items-center justify-center gap-2" wire:loading.attr="disabled">
