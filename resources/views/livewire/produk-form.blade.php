<div class="w-full">
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">{{ $produkId ? 'Edit Produk' : 'Tambah Produk Baru' }}</h1>
            <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Lengkapi informasi detail mengenai produk.</p>
        </div>
    ...
    <form wire:submit="simpan" class="bg-[#161B22] border border-[#30363D] rounded-2xl shadow-xl overflow-hidden">
        <div class="p-6 md:p-8 space-y-6">
            ...
            <div>
                <h3 class="text-sm font-bold text-slate-800 dark:text-slate-200 mb-4 pb-2 border-b border-[#30363D] flex items-center gap-2">
                    <i data-lucide="tag" class="w-4 h-4 text-[#58A6FF]"></i> Identifikasi Produk
                </h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        <label for="barcode" class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Barcode <span class="text-rose-500">*</span></label>
                    ...
                    <div>
                        <label for="sku" class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">SKU (Opsional)</label>
                ...
                <div class="mt-5">
                    <label for="name" class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Nama Produk <span class="text-rose-500">*</span></label>
            ...
            <div>
                <h3 class="text-sm font-bold text-slate-800 dark:text-slate-200 mb-4 pb-2 border-b border-[#30363D] flex items-center gap-2 mt-8">
                    <i data-lucide="layers" class="w-4 h-4 text-[#58A6FF]"></i> Pengaturan Stok & Relasi
                </h3>
                
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        <label for="min_stock" class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Batas Stok Minimum</label>
                    ...
                    <div>
                        <label for="max_stock" class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Batas Stok Maksimum</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
                    <div>
                        <label for="location" class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Penempatan Lokasi</label>
                        <input type="text" id="location" wire:model="location" placeholder="Misal: Rak A-1"
                            class="w-full bg-[#0D1117] border border-[#30363D] hover:border-[#8B949E] rounded-xl text-slate-800 dark:text-slate-200 placeholder-slate-600 focus:bg-[#161B22] focus:border-[#58A6FF] focus:ring-1 focus:ring-[#58A6FF] outline-none transition-all px-4 py-2.5">
                    </div>
                    <div>
                        <label for="supplier_id" class="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Pemasok Default</label>
                        <div class="relative">
                            <select id="supplier_id" wire:model="supplier_id"
                                class="w-full bg-[#0D1117] border border-[#30363D] hover:border-[#8B949E] rounded-xl text-slate-800 dark:text-slate-200 focus:bg-[#161B22] focus:border-[#58A6FF] focus:ring-1 focus:ring-[#58A6FF] outline-none transition-all px-4 py-2.5 appearance-none">
        ...
        <div class="px-6 md:px-8 py-4 bg-[#0D1117] border-t border-[#30363D] flex justify-end gap-3">
            <a href="{{ route('produk.index') }}" class="px-5 py-2.5 border border-[#30363D] hover:bg-[#30363D] text-slate-700 dark:text-slate-300 font-bold rounded-xl transition-colors text-sm">Batal</a>
