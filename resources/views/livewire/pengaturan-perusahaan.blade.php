    ...
    <div class="bg-white dark:bg-slate-900 card-shadow border border-[#D1D5DB] dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden transition-colors duration-300 ease-in-out">
        ...
        <form wire:submit="simpan" class="space-y-6 relative z-10">
            ...
            <div class="pt-6 border-t border-slate-200 dark:border-slate-800/50 flex justify-end transition-colors duration-300 ease-in-out">
                <button type="submit" class="w-full sm:w-auto px-8 py-3 bg-[#10B981] dark:bg-blue-500 hover:bg-[#388BFD] text-white font-bold rounded-xl transition-all shadow-lg shadow-[#1F6FEB]/20 flex items-center justify-center gap-2" wire:loading.attr="disabled">
