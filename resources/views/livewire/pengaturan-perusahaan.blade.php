<div class="max-w-4xl mx-auto pb-12">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-black text-[#0A1931] dark:text-white tracking-tight flex items-center gap-3 transition-colors duration-300 ease-in-out">
                <i data-lucide="building-2" class="w-8 h-8 text-[#58A6FF] transition-colors duration-300 ease-in-out"></i>
                Pengaturan Perusahaan
            </h1>
            <p class="text-[#4A7FA7]/70 dark:text-slate-400 text-sm mt-1 transition-colors duration-300 ease-in-out">Atur identitas utama perusahaan yang akan tampil di header laporan & Surat Jalan.</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-[#161B22] border border-[#B3CFE5]/30 dark:border-[#30363D] rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden transition-colors duration-300 ease-in-out">
        ...
        <form wire:submit="simpan" class="space-y-6 relative z-10">
            <div>
                <label class="block text-xs font-bold text-[#4A7FA7]/70 dark:text-slate-400 uppercase tracking-wider mb-2 transition-colors duration-300 ease-in-out">Nama Perusahaan <span class="text-rose-500 transition-colors duration-300 ease-in-out">*</span></label>
                ...
                @error('nama_perusahaan') <span class="text-rose-500 text-[11px] font-bold mt-1 block transition-colors duration-300 ease-in-out">{{ $message }}</span> @enderror
            </div>
            
            <div>
                <label class="block text-xs font-bold text-[#4A7FA7]/70 dark:text-slate-400 uppercase tracking-wider mb-2 transition-colors duration-300 ease-in-out">Alamat Lengkap</label>
                <textarea wire:model="alamat" rows="3" class="w-full px-4 py-3 bg-[#F6FAFD] dark:bg-[#0D1117] border border-[#B3CFE5]/30 dark:border-[#30363D] hover:border-[#8B949E] rounded-xl text-[#1A3D63] dark:text-slate-200 placeholder-slate-600 focus:bg-white dark:bg-[#161B22] focus:border-[#58A6FF] focus:ring-1 focus:ring-[#58A6FF] outline-none transition-all"></textarea>
            </div>
            
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    <label class="block text-xs font-bold text-[#4A7FA7]/70 dark:text-slate-400 uppercase tracking-wider mb-2 transition-colors duration-300 ease-in-out">Pusat Bantuan / Telepon</label>
                    <input type="text" wire:model="telepon" class="w-full px-4 py-3 bg-[#F6FAFD] dark:bg-[#0D1117] border border-[#B3CFE5]/30 dark:border-[#30363D] hover:border-[#8B949E] rounded-xl text-[#1A3D63] dark:text-slate-200 placeholder-slate-600 focus:bg-white dark:bg-[#161B22] focus:border-[#58A6FF] focus:ring-1 focus:ring-[#58A6FF] outline-none transition-all">
                </div>
                <div>
                    <label class="block text-xs font-bold text-[#4A7FA7]/70 dark:text-slate-400 uppercase tracking-wider mb-2 transition-colors duration-300 ease-in-out">Email Perusahaan</label>
            ...
            <div class="pt-6 border-t border-[#B3CFE5]/30 dark:border-[#30363D]/50 flex justify-end transition-colors duration-300 ease-in-out">
