            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        @if($produkDipilih)
                            <div class="flex items-center gap-3 p-3 bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800 rounded-xl">
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-bold text-slate-800 dark:text-slate-200 truncate">{{ $produkDipilih->name }}</p>
                                    <p class="text-xs font-mono text-slate-500">{{ $produkDipilih->barcode }} · Stok tersedia: <strong class="{{ $produkDipilih->current_stock > 0 ? 'text-emerald-600' : 'text-rose-600' }}">{{ $produkDipilih->current_stock }}</strong></p>
                                </div>
