...
<body class="bg-gray-100 flex flex-col min-h-screen items-center justify-center p-0 print:bg-white print:p-0">
    <!-- Controls -->
    <div class="no-print fixed top-4 right-4 flex gap-2 z-50">
        ...
        <button onclick="window.close()" class="px-6 py-3 bg-gray-600 hover:bg-gray-700 text-slate-900 dark:text-white font-bold rounded-lg shadow-lg transition-colors">
            Tutup
        </button>
    </div>
